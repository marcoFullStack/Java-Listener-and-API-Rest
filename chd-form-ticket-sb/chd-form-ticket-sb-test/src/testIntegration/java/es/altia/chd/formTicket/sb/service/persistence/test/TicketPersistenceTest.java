...
package es.altia.chd.formTicket.sb.service.persistence.test;
...
import es.altia.chd.formTicket.sb.exception.NoSuchTicketException;
import es.altia.chd.formTicket.sb.model.Ticket;
import es.altia.chd.formTicket.sb.service.TicketLocalServiceUtil;
import es.altia.chd.formTicket.sb.service.persistence.TicketPersistence;
import es.altia.chd.formTicket.sb.service.persistence.TicketUtil;
...
public class TicketPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "es.altia.chd.formTicket.sb.service"));
	...
	protected OrderByComparator<Ticket> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"CHDTICKET_Ticket", "uuid", true, "id", true,
			"formInstanceRecordId", true, "formInstanceId", true, "groupId",
			true, "createDate", true, "ticketId", true, "token", true, "email",
			true);
	}
